...
int _playerGroupEstimateSize(
  ...
  bytesCount += 3 + object.playerNames.length * 3;
  {
    for (var i = 0; i < object.playerNames.length; i++) {
      final value = object.playerNames[i];
...
void _playerGroupSerialize(
  ...
  writer.writeStringList(offsets[2], object.playerNames);
}
...
PlayerGroup _playerGroupDeserialize(
  ...
  object.playerNames = reader.readStringList(offsets[2]) ?? [];
  return object;
}
...
extension PlayerGroupQueryFilter
  ...
  QueryBuilder<PlayerGroup, PlayerGroup, QAfterFilterCondition>
  playerNamesElementEqualTo(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(
          property: r'playerNames',
          value: value,
          caseSensitive: caseSensitive,
        ),
      );
  ...
  QueryBuilder<PlayerGroup, PlayerGroup, QAfterFilterCondition>
  playerNamesElementStartsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.startsWith(
          property: r'playerNames',
  ...
  QueryBuilder<PlayerGroup, PlayerGroup, QAfterFilterCondition>
  playerNamesElementEndsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.endsWith(
          property: r'playerNames',
  ...
  QueryBuilder<PlayerGroup, PlayerGroup, QAfterFilterCondition>
  playerNamesElementContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.contains(
          property: r'playerNames',
  ...
  QueryBuilder<PlayerGroup, PlayerGroup, QAfterFilterCondition>
  playerNamesElementMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.matches(
          property: r'playerNames',
  ...
  QueryBuilder<PlayerGroup, PlayerGroup, QAfterFilterCondition>
  playerNamesElementIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'playerNames', value: ''),
      );
    });
  }

  QueryBuilder<PlayerGroup, PlayerGroup, QAfterFilterCondition>
  playerNamesElementIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(property: r'playerNames', value: ''),
      );
    });
  }

  QueryBuilder<PlayerGroup, PlayerGroup, QAfterFilterCondition>
  playerNamesLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'playerNames', length, true, length, true);
    });
  }
  ...
  playerNamesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'playerNames', 0, true, 0, true);
    });
  }

  QueryBuilder<PlayerGroup, PlayerGroup, QAfterFilterCondition>
  playerNamesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'playerNames', 0, false, 999999, true);
    });
  }

  QueryBuilder<PlayerGroup, PlayerGroup, QAfterFilterCondition>
  playerNamesLengthLessThan(int length, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'playerNames', 0, true, length, include);
    });
  }

  QueryBuilder<PlayerGroup, PlayerGroup, QAfterFilterCondition>
  playerNamesLengthGreaterThan(int length, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'playerNames', length, include, 999999, true);
    });
  }

  QueryBuilder<PlayerGroup, PlayerGroup, QAfterFilterCondition>
  playerNamesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension PlayerGroupQuerySortBy
  ...
  QueryBuilder<PlayerGroup, PlayerGroup, QAfterSortBy> sortByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
    });
  }

  QueryBuilder<PlayerGroup, PlayerGroup, QAfterSortBy> sortByCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PlayerGroupQuerySortThenBy
  ...
  QueryBuilder<PlayerGroup, PlayerGroup, QAfterSortBy> thenByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
    });
  }

  QueryBuilder<PlayerGroup, PlayerGroup, QAfterSortBy> thenByCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.desc);
    });
  }
...
extension PlayerGroupQueryWhereDistinct
  ...
  QueryBuilder<PlayerGroup, PlayerGroup, QDistinct> distinctByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PlayerGroup, PlayerGroup, QDistinct> distinctByPlayerNames() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'playerNames');
    });
  }
}
...
extension PlayerGroupQueryProperty
  ...
  QueryBuilder<PlayerGroup, DateTime, QQueryOperations> createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PlayerGroup, List<String>, QQueryOperations>
  playerNamesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'playerNames');
    });
  }
}
