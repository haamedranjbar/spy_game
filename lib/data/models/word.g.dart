...
P _wordDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_WorddifficultyValueEnumMap[reader.readByteOrNull(offset)] ??
              WordDifficulty.easy)
          as P;
    case 2:
...
const _WorddifficultyEnumValueMap = {'easy': 0, 'medium': 1, 'hard': 2};
const _WorddifficultyValueEnumMap = {
  0: WordDifficulty.easy,
  1: WordDifficulty.medium,
  2: WordDifficulty.hard,
};
...
extension WordQueryWhereSort on QueryBuilder<Word, Word, QWhere> {
  ...
  QueryBuilder<Word, Word, QAfterWhere> anyCategoryId() {
    return QueryBuilder.apply(this, (query) {
...
extension WordQueryWhere on QueryBuilder<Word, Word, QWhereClause> {
  ...
  QueryBuilder<Word, Word, QAfterWhereClause> categoryIdEqualTo(
    int categoryId,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<Word, Word, QAfterWhereClause> categoryIdNotEqualTo(
    int categoryId,
  ) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
  ...
  QueryBuilder<Word, Word, QAfterWhereClause> categoryIdGreaterThan(
    int categoryId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Word, Word, QAfterWhereClause> categoryIdLessThan(
    int categoryId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Word, Word, QAfterWhereClause> categoryIdBetween(
    int lowerCategoryId,
    int upperCategoryId, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension WordQueryFilter on QueryBuilder<Word, Word, QFilterCondition> {
  QueryBuilder<Word, Word, QAfterFilterCondition> categoryIdEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Word, Word, QAfterFilterCondition> categoryIdGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Word, Word, QAfterFilterCondition> categoryIdLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Word, Word, QAfterFilterCondition> categoryIdBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Word, Word, QAfterFilterCondition> difficultyBetween(
    WordDifficulty lower,
    WordDifficulty upper, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Word, Word, QAfterFilterCondition> textContains(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Word, Word, QAfterFilterCondition> textMatches(
    String pattern, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension WordQuerySortBy on QueryBuilder<Word, Word, QSortBy> {
  QueryBuilder<Word, Word, QAfterSortBy> sortByCategoryId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'categoryId', Sort.asc);
    });
  }

  QueryBuilder<Word, Word, QAfterSortBy> sortByCategoryIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension WordQuerySortThenBy on QueryBuilder<Word, Word, QSortThenBy> {
  QueryBuilder<Word, Word, QAfterSortBy> thenByCategoryId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'categoryId', Sort.asc);
    });
  }

  QueryBuilder<Word, Word, QAfterSortBy> thenByCategoryIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'categoryId', Sort.desc);
    });
  }
...
extension WordQueryWhereDistinct on QueryBuilder<Word, Word, QDistinct> {
  QueryBuilder<Word, Word, QDistinct> distinctByCategoryId() {
    return QueryBuilder.apply(this, (query) {
...
extension WordQueryProperty on QueryBuilder<Word, Word, QQueryProperty> {
  ...
  QueryBuilder<Word, int, QQueryOperations> categoryIdProperty() {
    return QueryBuilder.apply(this, (query) {
